    ...
    return Dismissible(
      ...
      child: CheckboxListTile(
        ...
        secondary: CircleAvatar(
          backgroundColor: Colors.black54,
          child: Icon(listaTarefas[index]["ok"] ? Icons.check : Icons.alarm),
        ),
        onChanged: (c) {
      ...
      onDismissed: (direcao) {
        setState(() {
          ultimoRemovido = Map.from(listaTarefas[index]);
          ...
          final snack = SnackBar(
            ...
            action: SnackBarAction(
                ...
                onPressed: () {
                  setState(() {
                    listaTarefas.insert(posicaoUltimoRemovido, ultimoRemovido);
                    salvarTarefas();
                  });
                }),
